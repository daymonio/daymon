...
> "Add Daymon as a global MCP server. Command: node /Applications/Daymon.app/Contents/Resources/mcp/server.js — env DAYMON_DB_PATH=~/Library/Application Support/daymon/daymon.db and DAYMON_SOURCE=claude-code"
